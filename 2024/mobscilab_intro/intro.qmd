...
* Data Science Fellowship @ Connected Places Catapult (Data Science Fellow) - <q>Mapping and modelling social isolation in Buckinghamshire</q>
* Masters Dissertation @ School of Mathematics (MSc Student) - <q>Exploiting network symmetries to reduce the state space of dynamic processes on networks</q>
